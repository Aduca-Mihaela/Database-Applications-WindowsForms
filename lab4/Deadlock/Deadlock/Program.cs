...
namespace Deadlock
{
    class Program
    {
        static string connectionString = "Data Source=LAPTOPEL\\SQLEXPRESS;Initial Catalog=SCOALASGBD;Integrated Security=True";
        ...
        static bool Transaction1_Run()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    // Set deadlock priority for Transaction 1
                    command.CommandText = "SET DEADLOCK_PRIORITY HIGH; EXECUTE DeadlockT1_C#";
        ...
        static bool Transaction2_Run()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    command.CommandText = "SET DEADLOCK_PRIORITY LOW; EXECUTE DeadlockT2_C#";
                    command.ExecuteNonQuery();
                    success = true;
